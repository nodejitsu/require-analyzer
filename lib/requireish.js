...
// running `requireish.package()` if it exists. Otherwise attempts to run
// `requireish.file()` on all files in the source tree.
//
requireish.dir = function (dir, callback) {
  ...
  fs.readdir(dir, function (err, files) {
    ...
    function onRequired () {
      ...
      // and all files have been executed via `requireish.file()`
      //
